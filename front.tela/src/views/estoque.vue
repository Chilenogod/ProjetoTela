<template>
  <div>
    <v-toolbar flat >
      ...
      <v-btn fab small  @click="atualizaEstoque({})" dark color="success" title="Novo Produto"><v-icon>mdi-package-variant-closed-plus</v-icon></v-btn>
    </v-toolbar>
    <v-data-table :headers="headers" :items="produtos" :search="search" hide-default-footer disable-pagination dense @click:row="atualizaEstoque">
